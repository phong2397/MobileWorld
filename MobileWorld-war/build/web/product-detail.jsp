...
<div class="linking">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li><a href="./Category?id=${product.category.id}">${product.category.name}</a></li>
            <li class="active">${product.brand.name} ${product.name}</li>
        </ol>
    </div>
</div>
                            ...
                            <article class="slider-item on-nav">
                                <div id="slider" class="flexslider">
                                    <ul class="slides">
                                        <c:forEach items="${product.imageCollection}" var="item">
                                            <li>
                                                <img src="./uploads/${item.source}" alt="">
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </div>
                                <div id="carousel" class="flexslider">
                                    <ul class="slides">
                                        <c:forEach items="${product.imageCollection}" var="item">
                                            <li>
                                                <div style="background-image: url(./uploads/${item.source}); width: auto; height: 50px; background-size: contain; background-position: center; background-repeat: no-repeat"></div>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </div>
                        ...
                        <div class="col-xs-7">
                            ...
                            <div class="clr">
                                ...
                                <c:forEach items="${colors}" var="item">
                                    <span style="background:${item.hexCode}; border: 1px solid #aaaaaa"></span>
                                </c:forEach>
                            </div>
                                ...
                                <c:forEach items="${product.ratingCollection}" var="item" varStatus="loop">
                                    <div class="rev-group <c:if test="${loop.index < product.ratingCollection.size() - 1}">mb-5</c:if>">
                                            <div class="rev-header">
                                                <div class="avt">
                                                    <img src="./uploads/${item.customer.avatar != '' ? item.customer.avatar : 'user-64.png'}" />
                                            </div>
                                            <div class="cus">
                ...
                <div class="product">
                    <article>
                        <a href="./product?id=${item.id}">
                            <img class="img-responsive" src="./uploads/${item.thumb}" alt="Image" > 
                        </a>
                        <!-- Content --> 
