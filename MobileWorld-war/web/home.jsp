...
<div class="container">
    <div class="row"> 
        <%@include file="include/left-sidebar.jsp" %>
                            ...
                            <c:forEach items="${promotions}" var="item">
                                ...
                                <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                                    ...
                                    <div class="tp-caption sfl tp-resizeme" data-x="left" data-hoffset="50" data-y="center"
                                         ...
                                         style="z-index: 1;"><img src="./uploads/${item.thumb}" alt=""> </div>
    ...
    <section class="padding-top-0 padding-bottom-30"> 
        ...
        <!-- Heading -->
        <div class="heading">
            <h2 class="text-uppercase">Most popular phones</h2>
            <hr>
        </div>
                ...
                <div class="product">
                    <article>
                        <a href="./product?id=${item.id}">
                            <img class="img-responsive primary-img" src="./uploads/${item.thumb}" alt="Image" >
                        </a>
                        <!-- Content --> 
                        <span class="tag">${item.category.name}</span>
                        <a href="./product?id=${item.id}" class="tittle">${item.brand.name} ${item.name}</a>
    ...
    <!-- Latest Products -->
    <section class="padding-top-60 padding-bottom-90"> 
        ...
        <!-- Items Slider -->
        <div class="item-slide-4 with-nav"> 
            <c:forEach items="${lastestProducts}" var="item">
                <!-- Product -->
                <div class="product">
                    <article> 
                        <a href="./product?id=${item.id}">
