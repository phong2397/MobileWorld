                    ...
                    <div class="go-right"> 
                        ...
                        <form action="/MobileWorld-war/filter" method="get">
                            <div class="search-cate">
                                ...
                                <input type="search" name="txt" placeholder="Search entire store here..." value="<%= request.getParameter("txt") != null ?  request.getParameter("txt") : ""%>">
            ...
            <nav class="navbar ownmenu">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="nav-open-btn">
                        <ul class="nav">
                            <li>
                                <a href="/MobileWorld-war">Home </a>
                            </li>

                            <li>
                                <a href="/MobileWorld-war/product">Products </a>
                            </li>
