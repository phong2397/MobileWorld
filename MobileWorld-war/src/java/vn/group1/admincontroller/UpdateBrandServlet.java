 ...
 * @author lehun
 */
@WebServlet(name = "UpdateBrandServlet", urlPatterns = {"/admin/update-brand"})
       ...
       HttpSession session = request.getSession();
        ...
        switch (action) {
            ...
            case "update-brand":
                ...
                String avatar = request.getParameter("logo");
                String category = request.getParameter("category");

                Brand brand = brandFacade.find(id);
                brand.setName(name);
                 if (avatar != null) {
                    brand.setLogo(avatar);
                }
